      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md">
        <div className="p-6">
          ...
          <div className="mt-4 border rounded-md p-4">
            ...
            <div className="grid grid-cols-7 gap-1 text-center">
              ...
              <div className="p-2 rounded-md cursor-pointer" style={{ backgroundColor: "#E6F0FF", color: "#0040A0" }}>
                2
              </div>
              ...
              <div className="p-2 text-white rounded-md cursor-pointer" style={{ backgroundColor: "#0040A0" }}>
                18
              </div>
        ...
        <div className="flex justify-between p-4 border-t">
          ...
          <Button
            ...
            style={{ backgroundColor: "#0040A0", borderColor: "#0040A0" }}
