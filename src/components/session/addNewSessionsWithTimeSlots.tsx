            ...
            <div className="border rounded-md p-3">
              <div className="flex gap-4 mb-3">
                ...
                <div className="flex-none">
                  <Button variant="outline" className="text-red-500 border-red-200 hover:text-red-600">
                    Remove
                  </Button>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-none">
                  <Button className="text-white" style={{ backgroundColor: "#0040A0" }}>
                    Add
                  </Button>
                </div>
              </div>
