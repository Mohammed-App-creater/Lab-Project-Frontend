  ...
  return (
    <div className="mb-6 sm:mb-8">
      ...
      <div className="border rounded-lg bg-white shadow-sm overflow-hidden">
        ...
        >
          <h3 className="font-medium text-gray-900">Resources ({resources.length})</h3>
        ...
        {isOpen && (
          <div className="divide-y divide-gray-100">
            {resources.length > 0 ? (
              ...
              <div className="py-4 px-4 text-sm text-gray-500 text-center">No resources added yet.</div>
            )}
          </div>
        )}
      </div>
